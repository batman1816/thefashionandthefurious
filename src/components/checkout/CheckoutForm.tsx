          ...
          <div className="p-6 border border-zinc-900 bg-zinc-900 rounded-xl">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input type="text" value={bkashSenderNumber} onChange={e => setBkashSenderNumber(e.target.value)} placeholder="01XXXXXXXXX" required className="w-full px-4 py-3 border border-gray-600 rounded-lg text-black placeholder-gray-400 focus:outline-none focus:border-gray-500 bg-white" />
              </div>
              ...
              <div>
                ...
                <input type="text" value={bkashTransactionId} onChange={e => setBkashTransactionId(e.target.value)} placeholder="Txn ID" required className="w-full px-4 py-3 border border-gray-600 rounded-lg text-black placeholder-gray-400 focus:outline-none focus:border-gray-500 bg-white" />
              </div>
            </div>
          </div>
