      ...
      <Card className="mb-8 bg-zinc-800 border-gray-700">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {sales.map((sale) => (
              <div key={sale.id} className="bg-zinc-900 p-4 rounded-lg">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {bundleDeals.map((bundle) => (
              <div key={bundle.id} className="bg-zinc-900 p-4 rounded-lg">
                <div className="flex justify-between items-start mb-3">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input 
                    ...
                    onChange={(e) => setSaleForm({...saleForm, original_price: parseInt(e.target.value)})}
                    className="w-full px-3 py-2 bg-zinc-700 border border-zinc-600 rounded text-white"
                  />
                </div>
                <div>
                  ...
                  <input 
                    ...
                    onChange={(e) => setSaleForm({...saleForm, sale_price: parseInt(e.target.value)})}
                    className="w-full px-3 py-2 bg-zinc-700 border border-zinc-600 rounded text-white"
                  />
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input 
                    ...
                    onChange={(e) => setBundleForm({...bundleForm, minimum_quantity: parseInt(e.target.value)})}
                    className="w-full px-3 py-2 bg-zinc-700 border border-zinc-600 rounded text-white"
                  />
                </div>
                <div>
                  ...
                  <input 
                    ...
                    onChange={(e) => setBundleForm({...bundleForm, discount_percentage: parseInt(e.target.value)})}
                    className="w-full px-3 py-2 bg-zinc-700 border border-zinc-600 rounded text-white"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setBundleForm({...bundleForm, max_discount_items: parseInt(e.target.value)})}
                  className="w-full px-3 py-2 bg-zinc-700 border border-zinc-600 rounded text-white"
                />
              </div>
