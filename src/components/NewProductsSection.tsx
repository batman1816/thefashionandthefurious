      ...
      <div className="container mx-auto px-4">
        ...
        {productsWithSales.length > 0 ? <>
            ...
            <div className="text-center">
              <Link to="/new-products" className="inline-block bg-black hover:bg-gray-800 text-white px-8 py-3 font-poppins font-medium transition-colors duration-300 uppercase tracking-wide text-sm">
                VIEW ALL
              </Link>
            </div>
