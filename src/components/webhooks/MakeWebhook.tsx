...
const MakeWebhook = ({
  ...
  return <Card className="border-gray-700 bg-zinc-900">
      ...
      <CardContent className="space-y-4 bg-zinc-900">
        <div>
          ...
          <Input id="webhook-url" type="url" placeholder="https://hook.eu1.make.com/..." value={webhookUrl} onChange={e => setWebhookUrl(e.target.value)} className="bg-gray-700 border-gray-600 text-white mt-2" />
          <p className="text-sm text-gray-400 mt-2">
            Enter your Make.com webhook URL to receive order notifications
          </p>
        </div>

        {currentUrl && <div className="bg-green-900/20 border border-green-700 rounded-lg p-3">
        ...
        <div className="flex gap-3">
          <Button onClick={handleSaveWebhook} className="bg-blue-600 hover:bg-blue-700">
            Save Webhook
          </Button>
          <Button onClick={handleTestWebhook} disabled={isLoading || !webhookUrl.trim()} variant="outline" className="border-gray-600 text-gray-300 hover:bg-gray-700">
        ...
        <div className="border border-yellow-700 rounded-lg p-4 bg-zinc-950">
