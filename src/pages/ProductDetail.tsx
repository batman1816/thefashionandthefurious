        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col">
            ...
            {product.saleInfo && product.originalPrice ? <div className="text-2xl font-normal text-gray-900 mb-6">
              ...
              </div> : <div className="text-2xl font-normal text-gray-900 mb-6">
                Tk {product.price}.00
              </div>}
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center gap-4">
                <button onClick={() => setQuantity(Math.max(1, quantity - 1))} className="p-2 border border-gray-300 hover:border-gray-400" disabled={quantity <= 1}>
                  <Minus size={16} />
                </button>
                <span className="font-medium w-12 text-center text-base">
                  {quantity}
                </span>
                <button onClick={() => setQuantity(quantity + 1)} className="p-2 border border-gray-300 hover:border-gray-400">
                  <Plus size={16} />
                </button>
              </div>
            </div>
