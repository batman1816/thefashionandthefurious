        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col">
            ...
            {product.saleInfo && product.originalPrice ? <div className="text-2xl font-normal text-gray-900 mb-6">
                ...
                {product.category === 'mousepads' && product.size_pricing && selectedSize ? `Tk ${product.size_pricing[selectedSize] || product.price}.00` : `Tk ${product.price}.00`}
              </div>}
            ...
            {product.category !== 'mousepads' && <div className="mb-6">
                <SizeChart />
              </div>}
